...
public class TicTacToe {
    ...
    protected char userMarker; // X marker or O marker
    protected char aiMarker; // computers X or O marker
    protected char winner;
    protected char currentMarker; // whos turn is it
    ...
    public boolean isThereAWinner() {
        ...
        //returns true if there is a winner and we already saved the winner
    }
